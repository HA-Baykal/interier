...
export type PlanOptions = {
  /**
   * A targeted edit replaces the restyle prompt: the model is told to change
   * only the requested details. Set by instruction parsing (web studio, bots).
   */
  promptOverride?: string | null;
  /** Short human label of what is being changed, for the progress note. */
  instructionSummary?: string | null;
};

export async function planGeneration(
  style: Style,
  settings?: Awaited<ReturnType<typeof getGenerationSettings>> | null,
  opts?: PlanOptions

...
export const IMAGE_QUALITIES = ["medium", "high"] as const;
...
export const GPT_IMAGE_2_PRICE_ESTIMATES: Record<ImageQuality, number> = { medium: 15, high: 55 };
export const GPT_IMAGE_2_PRICE_DATE = "2026-09-05";

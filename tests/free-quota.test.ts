...
function data(limit = "10", generations: Generation[] = []): DbShape {
  return { users: [customer], sessions: [], generations, rewards: [], referrals: [], styles: [], packages: [], payments: [], settings: [{ key: "daily_free_image_limit", value: limit }], botChats: [], botLinks: [] };
}
